...
\033[1;32m[✓]AUTHOR  :\033[1;32m AMINUL
\033[1;32m[✓]TOOL    :\033[1;32m NEW 
\033[1;32m[✓]FACEBOOK:\033[1;32m AminulislamMona1
...
def auto_pass(fileeee):
    ...
    print(cox)
    print("  [✓] Id Save: /sdcard/AMINUL.txt")
    print(cox)
...
def file_subb(uid,pwx):
    global oks,loop
    sys.stdout.write(f"\r  \033[38;5;46m[AMINUL] {loop}|{str(len(oks))}");sys.stdout.flush()
